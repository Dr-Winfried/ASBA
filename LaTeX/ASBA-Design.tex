...
\begin{enumerate}
	...
	\item \label{Anforderung:Form} \DefFt{Form}:
	Die Daten liegt in formaler, geprüfter Form vor.
	--- \vrefseeziel{Ziel:Form}

	\item \label{Anforderung:Eingaben} \DefFt{Eingaben}:
	...
	\item \label{Anforderung:Pruefung} \DefFt{Prüfung}:
	Vorhandene \Beweise\ können automatisch geprüft werden.
	--- \vrefseeziel{Ziel:Pruefung}

	\item \label{Anforderung:Ausgaben} \DefFt{Ausgaben}:
	...
	\item \label{Anforderung:Auswertungen} \defTxt{\Auswertungen}:
	...
	\item \label{Anforderung:Anpassbarkeit} \DefFt{Anpassbarkeit}:
	...
	\item \label{Anforderung:Individualitaet} \DefFt{Individualität}:
	...
	\item \label{Anforderung:Internet} \DefFt{Internet}:
	...
	\item \label{Anforderung:Bedienbarkeit} \DefFt{Bedienbarkeit}:
	\ASBA\ ist einfach zu bedienen.
	--- \vrefseeziel{Ziel:Bedienbarkeit}

	\item \label{Anforderung:Zwischenspeicher} \DefFt{Zwischenspeicher}:
	Wichtige \Auswertungen\ können an vorhandenen Dateien angehängt oder separat in eigenen Dateien gespeichert werden.
	--- \vrefseeziel{Ziel:Zwischenspeicher}

	\item \label{Anforderung:Beweisunterstuetzung} \DefFt{Beweisunterstützung}:
	\ASBA\ hilft bei der Erstellung von \Beweisen.
	--- \vrefseeziel{Ziel:Beweisunterstuetzung}
