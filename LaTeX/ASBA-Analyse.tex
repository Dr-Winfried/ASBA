...
\footnote{%
	Ein \emph{\glsIdx{Fachgebiet}} ist ein Teil der Mathematik mit einer zugehörigen Basis an Axiomen, \glsIdxPl{Satz}n, \glsIdxPl{Fachbegriff}n und Darstellungen, \textzB\ \emph{Logik}, \emph{Mengenlehre} und \emph{Gruppentheorie}.
...
\begin{itemize}
	...
	\begin{description}
		...
		Die Datei wird um zusätzliche Auswertungen ergänzt, \textzB\ ob die \glsIdxPl{Beweis} korrekt sind, welche \glsIdxPl{Axiom} und \glsIdxPl{Satz} -- auch externe aus dem Internet -- verwendet wurden, Länge des Beweises \textusw
	\end{description}
	%
