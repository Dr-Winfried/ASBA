...
\section{Umgebung von \textsf{ASBA}}% ======================================
...
Da ein Computerprogramm erstellt werden soll, muss die Grundstruktur des Vorgehens bei Beweisen definiert werden.\footnote{\seename~\cite{bib:Kalkuel}}
...
\paragraph{Transformationsregeln} definieren, welche Transformationen von gegebenen Formelmengen zulässig sind.\footnote{\seename~\cite und~\cite{bib:NatuerlichesSchliessen}}
