...
\footnote{%
	Ein \defTxt{\Fachgebiet} ist ein Teil der Mathematik mit einer zugehörigen Basis an \Axiomen, \Saetzen, \Fachbegriffen\ und Darstellungen, \textzB\ \emph{Logik}, \emph{Mengenlehre} und \emph{Gruppentheorie}.
...
\begin{table}[H]
	...
	\label{tab-Fragen2Eigenschaften}
\end{table}
...
\footnote{%
	...
	Da dieser Begriff auch \vrefincha{cha-Design} verwendet wird, werden die Anforderungen hier \Ziele\ genannt.
}
gesetzt:
\begin{enumerate}
	%
