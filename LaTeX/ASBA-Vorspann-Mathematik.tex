...
\newglossaryentry{Formelmenge}{
	...
	description={
		\textIAlg\ eine Menge von Formeln $\Formel$ \textbzw\ Worten.
...
\newglossaryentry{Folgerung}{
	...
	plural={Folgerungen},
	description={
		Die Folgerungen einer \emph{Schlussregel} $\frac{\Voraussetzungsmenge}{\Folgerungsmenge}$ sind die Elemente von $\Folgerungsmenge$.
	}
}
...
\newglossaryentry{Schlussregel}{
	...
	description={
		...
		Wenn alle \emph{Voraussetzungen} $\Voraussetzung$ aus $\Voraussetzungsmenge$ zutreffen, dann auch alle \emph{Folgerungen} $\Folgerung$ aus $\Folgerungsmenge$.
...
\newglossaryentry{Schlussregelmenge}{
	...
	description={
		Eine Menge von \emph{Schlussregeln}, meistens mit $\Schlussregelmenge$ bezeichnet.
	}
}
...
\newglossaryentry{Symbol}{
	...
	plural={Symbole},
	description={
		Ein Symbol entspricht genau einem Zeichen, kann aber aus mehreren Buchstaben zusammengesetz sein.
...
\newglossaryentry{Voraussetzung}{
	...
	description={
		Die Voraussetzungen einer \emph{Schlussregel} $\frac{\Voraussetzungsmenge}{\Folgerungsmenge}$ sind die Elemente von $\Voraussetzungsmenge$.
	}
}
