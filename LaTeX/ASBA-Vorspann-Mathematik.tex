...
\DeclareMathOperator{\metaandsym}{\&}%         ... und  ...
\DeclareMathOperator{\metaand}{\metaandsym\,}% ... und  ... (besserer Abstand)
\DeclareMathOperator{\metaorsym}{||}%          ... oder ...
\DeclareMathOperator{\metaor}{\metaorsym\,}%   ... oder ... (besserer Abstand)
...
\newglossaryentry{metaand}{
	name={$ \metaandsym$},
	plural={\metaandsym},% im Mathematikmodus
	description={%
...
\newglossaryentry{metaor}{
	name={$ \metaorsym$},
	plural={\metaorsym},% im Mathematikmodus
	description={%
...
\newglossaryentry{srand}{
	...
	description={%
		Ein \emph{Metaoperator}: ... und ...
		Die Priorität ist niedriger als die von \symqt{\metaandsym}%
	}
}
...
\newglossaryentry{Menenlehre}{
	name={Menenlehre},
	description={%
		\vrefseesec{sec:Menenlehre}%
	}
}
\newglossaryentry{Metaoperator}{
	...
	description={%
		Ein Operator der Metasprache, dargestellt duch ein Symbol: \objqt{\metaimp}, \objqt{\metarep}, \objqt{\metaequiv}, \objqt{\metaandsym}, \objqt{\metaorsym} und \objqt{\srand}%
	}%
}
...
\newglossaryentry{Vergleichsoperator}{ %%% veraltet %%%
	name={Vergleichsoperator},
	plural={Vergleichsoperatoren},
	description={%
