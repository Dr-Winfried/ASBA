...
\newcommand*{\derive}   {\;\vdash\;}%      ... ableitbar ...
\newcommand*{\derivegls}{\vdash}%          -"- für Glossar
...
\newglossaryentry{eq}{
	...
	description={%
		Eine (Meta-)Relation: ... gleich (ist dasselbe wie, ist identisch zu) ..%
	}
}
\newglossaryentry{equiv}{
	...
	description={%
		Eine(Meta-)Relation: ... äquivalent zu (ist das gleiche wie, ist so wie) ..%
	}
}
...
\newglossaryentry{metadefeq}{
	...
	description={%
		Eine Meta-Definition: ... definitionsgemäß gleich (definitionsgemäß genau dann, wenn) ..%
	}
}
...
\newglossaryentry{nequiv}{
	...
	description={%
		Eine (Meta-)Relation: ... nicht äquivalent (ist nicht das gleiche wie, ist nicht so wie) ..%
	}
}
...
\newglossaryentry{notc}{
	...
	description={%
		Beweistechnik \enquote{Indirekter \glsIdx{Beweis}}%
	}
}
...
\newglossaryentry{notd}{% statt "notE"
	...
	description={%
		Reductio ad absurdum (indirekter \glsIdx{Beweis})%
	}
}
...
\newglossaryentry{atomareFormelV}{
	name={atomare Formel},    % eine  ...
	plural={atomare Formeln}, % viele ...
	description={%
...
\newglossaryentry{Formel}{
	...
	plural={Formeln},
	description={%
		Unter einer \emph{Formel} verstehen wir in diesem Dokument stets eine mathematische Formel.
		Diese kann auch mehrdimensional sein, lässt sich aber mittels geeigneter Definitionen immer eindeutig als eine Zeichenfolge schreiben%
	}%
}
...
\newglossaryentry{Kontraposition}{
	...
	description={%
		Die allgemeingültige Aussage \forqt{(\alpha \limp \beta) \limp (\lnot\beta \limp \lnot\alpha)}%
	}%
}
...
\newglossaryentry{vergleichbar}{ %TODO muss überarbeitet werden
	name={vergleichbar},
...
\newglossaryentry{Wahrheitswert}{
	...
	description={%
		Wahrheitswerte sind die Werte \symqt{\wahr} und \symqt{\falsch}, oft auch als \symqt{\true} und \symqt{\false} oder einfach \symqt{1} und \symqt{0} bezeichnet%
	}
}
