...
\begin{document}
	...
	\begin{itemize}
		...
		\item \label{Werkzeug:VSC} \emph{Visual Studio Community 2015} (\textbf{VS}) als Entwicklungsumgebung für C++.
	...
	\thispagestyle{scrheadings}
    \begin{minipage}{\textwidth}
    	\addcontentsline{toc}{chapter}{Literaurverzeichnis}
        \begin{thebibliography}{12}
            \bibitem{Hilbert II}\emph{Hilbert II - Introduction.} \url{http://www.qedeq.org/}
            \bibitem{qedeq}\emph{Formal Correct Mathematical Knowledge.} GitHub Repository of Projekt Hilbert II \url{https://github.com/m-31/qedeq/}
