	...
	\thispagestyle{scrheadings}
   	...
   	\begin{flushleft}
		\begin{thebibliography}{12}
			...
			\bibitem{GPLi}\emph{GNU General Public License} $\rightarrow$ \url{http://www.gnu.org/licenses/old-licenses/gpl-1.0}
			...
			\bibitem{Clover}Lizenz für \emph{Clover} $\rightarrow$ \url{https://www.atlassian.com/software/clover}
			
			\bibitem{EULA}Lizenz für \emph{Microsoft Visual Studio Community} (Microsoft Visual Studio Express 2015) $\rightarrow$ \url{https://www.visualstudio.com/de/license-terms/mt171551/}
			
			\bibitem{MiKTeX}Lizenz für \emph{MikTeX} $\rightarrow$ \url{https://miktex.org/kb/copying}
				
			\bibitem{SAX}Lizenz für \emph{SAX} $\rightarrow$ \url{http://www.saxproject.org/copying.html}
			
			\bibitem{MIT}\emph{MIT License} $\rightarrow$ \url{https://opensource.org/licenses/MIT/}
			
			\bibitem{JavaSE}\emph{Oracle Binary Code License Agreement} $\rightarrow$ \url{http://java.com/license}
			...
			\bibitem{WDCDL}\emph{W3C Document License} $\rightarrow$ \url{http://www.w3.org/Consortium/Legal/2015/doc-license}
			
			\bibitem{WDCSNL}\emph{W3C Software Notice and License} $\rightarrow$ \url{http://www.w3.org/Consortium/Legal/2002/copyright-software-20021231.html}
			
			\bibitem{HilbertII}\emph{Hilbert II - Introduction} $\rightarrow$ \url{http://www.qedeq.org/}
			
			\bibitem{qedeq}\emph{Formal Correct Mathematical Knowledge}: GitHub Repository von Projekt Hilbert II $\rightarrow$ \url{https://github.com/m-31/qedeq/}
			
			\bibitem{ASBA}\emph{ASBA - Axiome, Sätze, Beweise und Ausgaben}. Projekt zur maschinellen Überprüfung von mathematischen Beweisen und deren Ausgabe in lesbarer Form: GitHub Repository von Projekt ASBA $\rightarrow$ \url{https://github.com/Dr-Winfried/ASBA}
			
			\bibitem{Logik}Meyling, Michael: \emph{Anfangsgründe der mathematischen Logik} - 24. Mai 2013 $\rightarrow$ \url{http://www.qedeq.org/current/doc/math/qedeq_logic_v1_de.pdf}
			
			\bibitem{FLogik}Meyling, Michael: \emph{Formale Prädikatenlogik} - 24. Mai 2013 $\rightarrow$ \url{http://www.qedeq.org/current/doc/math/qedeq_formal_logic_v1_de.pdf}
			
			\bibitem{Mengenlehre}Meyling, Michael: \emph{Axiomatische Mengenlehre} - 24. Mai 2013 $\rightarrow$ \url{http://www.qedeq.org/current/doc/math/qedeq_set_theory_v1_de.pdf}
