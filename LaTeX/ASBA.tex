...
\begin{document}
	...
	% Optionen -> TeXstudio konfigurieren -> Erzeugen -> Übersetzen nach PDF:
	%     txs:///pdflatex | txs:///makeindex | txs:///pdflatex | txs:///view-pdf
	%
	...
	% erzeugte Datei 'ASBA.gls' modifiziert werden.
	%
	% Dies tut das Batchprogramm 'erzeugeIndizes.bat' und fügt mit Hilfe des
	% Batchprogramms 'einfuegen.bat' in die Datei 'ASBA.gls' nach der zweiten
	% Zeile je eine Zeile mit "\insertglo" und dem anschließenden Kommentar
	% "% -- Eingefuegt" ein.
	%
	...
	%
	% Das Kommandos '\insertglo' muss vor Aufruf von '\printglossaries' mit
