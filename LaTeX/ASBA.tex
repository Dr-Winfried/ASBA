...
\input{ASBA-Vorspann}
\input{ASBA-Vorspann-Logik.tex}
\input{ASBA-Vorspann-Glossar.tex}
\input{ASBA-Glossar-Texte.tex}
...
\begin{document}
	...
	\newcommand{\glopreambelEinordnung}{
		...
		Sind das Substantiv und \textggf\ ein oder mehrere Adjektive schon vorher aufgelistet worden, werden diese Worte durch je ein "`---"' ersetzt.
		\par
	}
...
%%%	}
	\newcommand{\glopreambelSymbolbeschreibung}{
		...
		Die Wörter \ManFt{in dieser} Schriftart sind notwendig für die Definition, solche \OptFt{in dieser} Schriftart können auch weggelassen werden.
		\par
	}
	\newcommand{\glopreambelWikipedia}{
		...
		} aus dem entsprechenden \Wikipedia-Artikel zitiert, manchmal gekürzt und immer ohne die originalen Fußnoten und ohne Links auf das Literaturverzeichnis des Artikels und andere \Wikipedia-Artikel.
		Letztere werden allerdings noch, wie in \Wikipedia, in \wikiLinkFt{\wikiFarbe} angegeben.
		\par
	}
