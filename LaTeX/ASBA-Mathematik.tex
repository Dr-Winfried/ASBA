...
\end{align}
%
Insbesondere bei den Schlussregeln\vrefnotesec{sec:Schlussregeln} ist es üblich, \symqt{$\und$} statt \symqt{$\metaund$} bei schwächerer Priorität\vrefnotetab{tab:Prioritaeten} zu verwenden.
%
...
\begin{equation}
	\label{eq:asM}
	\glsSym{asM} \quad \defeq \quad \{
		\eq, \ne, \equiv, \notequiv, \quad
		\defeq, \quad
		\metaund, \metaoder, \quad
		\metaimp, \metarep, \quad
		\metaequiv, \quad
		\metadefeq
	\}
\end{equation}
die Menge der \glsIdxBg{MetaoperatorV}{metasprachlichen Operatoren} und der mit Gleichheit verwandten Symbole.
Die Operatoren sind für den Fall fehlender Klammern nach ihren Prioritäten in absteigender Reihenfolge angegeben.
Zwischen Operatoren gleicher Priorität ist nur ein kleiner Abstand.
...
Diese werden \vrefintab{tab:Prioritaeten} mit abnehmender Priorität aufgelistet.
%
\begin{table}[!htb]
	\setlength\extrarowheight{1.5pt}
	\begin{center}
