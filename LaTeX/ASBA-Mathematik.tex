...
%%%		\textZB\ könnte man eine 2$\times$2--Matrix auch schreiben als Folge von Zeilen: \seqqt{$[(a,b),(c,d)]$}, oder noch einfacher: \seqqt{$[a,b;c,d]$}.
	...
	Man kann eine \glsIdx{Formel} auch dadurch charakterisieren, dass sie ein Element einer vorgegebenen Menge $\formulaset$ von \glsIdxPl{Zeichenfolge} ist.%
	\footnote{%
...
\begin{tabular}{llll}
	...
	\\
	& \seqqt{$\sin$} & Eine \glsIdx{Zeichenfolge} (\glsIdx{Formel})
...
Jeder \Beweisschritt\ $ \proofstep_k \text{ für } 1 \le k \le K $ muss entweder eine \glsIdx{Voraussetzung} aus $\prerequisiteset$ oder durch Anwendung einer \allgemeingueltigenSchlussregel\ auf eine Teilmenge von $\proofstepset_{k-1}$ eine wahre Formel oder eine weitere \emph{allgemeingueltige Schlussregel} sein.
