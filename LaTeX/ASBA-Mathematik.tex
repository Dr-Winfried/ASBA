...
%TODO Verweis auf Schlussregeln)
...
%TODO Umlauten in Verweisen verwenden
...
Weitere Verabredungen für \symqt{\opubsp} treffen wir nicht.
...
Wird eine binäre Relation \objqt{\relbsp} zusammen mit einer binären Operation \objqt{\opbsp} oder einer weiteren binären Relation \objqt{\relbsp'} verwendet wird, treffen wir folgende -- auch in der Literatur\footnote{\textzB~\cite{bib:Rautenberg}, Notationen Seite~xxi} verwendete -- Verabredung:
%
\begin{align}
...
\footnote{Priorität 1 ist höher und bindet damit stärker als Priorität 2, \textusw}
	...
	\begin{center}
		\begin{threeparttable}
			...
			\begin{tablenotes}
				...
				\item[9] %TODO \vrefseesub{sub:???}\newline
				\symqt{\srand} wird nur bei den \emph{Schlussregeln} verwendet.
...
%TODO \seename ersetzen
%TODO \textusw am Satzende in \textuswsatzende
\begin{description}
	%
	...
	\footnote{%
		...
		\textZB\ bezeichnen \symqt{\metaandsym} und \symqt{\srand} (siehe \vrefsec{sec:Beweise}) denselben Operator, haben aber verschiedene Priorität. -- \seename~\vreftab{tab:Prioritäten}%
	}
...
\end{align}
-- \objqt{\Beweisschrittmenge_{-1}} ist die leere Menge --
muss jeder \glsIdx{Beweisschritt} \objqt{\Beweisschritt_k \text{ für } 0 \le k \le K} entweder eine \glsIdx{Voraussetzung} aus \objqt{\Voraussetzungen} oder durch Anwendung einer \emph{zulässigen \glsIdx{Schlussregel}} auf eine Teilmenge von \objqt{\Beweisschrittmenge_{k-1}} eine wahre Formel oder eine weitere zulässige Schlussregel sein.
...
\[
	\frac{\Voraussetzungen}{\Folgerungen} \qquad \text{\textbzw} \qquad
	...
	\qquad \qquad \text{\emph{(\glsIdx{formalerSatzV})}}
	\tag{\tagFS} \sym{\gls{FS}}
...
Die \objqt{\Voraussetzung_n} können dabei beliebig permutiert werden. Gleiches gilt für die \objqt{\Folgerung_m}.
