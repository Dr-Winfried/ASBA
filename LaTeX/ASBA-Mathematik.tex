...
Diese Transformationen werden in ASBA die sogenannten \emph{\Idx{Schlussregel}n} sein, die später behandelt werden.
Zunächst werden dazu Elemente der \emph{\Idx{Aussagenlogik}} und der \emph{\Idx{Prädikatenlogik}} behandelt.
