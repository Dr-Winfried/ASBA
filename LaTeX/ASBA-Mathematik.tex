...
\begin{description}
	\item[\defTxt{\Wahrheitswert}] \glsdesc*{Wahrheitswert}%
	...
	\end{table}
	%
	\item[\defTxt{\Aussage}] \glsdesc*{Aussage}%
	\appendAussage
\end{description}
...
\begin{description}
	\item[\defTxt{\Unteraussage}] Eine \Aussage\ $A$ heißt eine \defTxt{\Unteraussage} \defFt{von} einer \Aussage\ $B$, wenn sie Teil von $A$ ist.
	Man sagt dann auch, dass $B$ die \Unteraussage\ $A$ enthält.
	\item[\defTxt{\echte} \Unteraussage] Eine \Unteraussage\ $A$ von $B$ heißt \defTxt{\echte} \Unteraussage\ von $B$, wenn $A$ verschieden von $B$ ist.
	\item[\defTxt{\zerlegbare} \Aussage] Eine \Aussage\ heißt \zerlegbar%
	\alternativ[
	...
	\item[\defTxt{\atomare} \Aussage] Eine \Aussage\ heißt \atomar\alternativ{unzerlegbar}, wenn sie nicht \zerlegbar\ ist, \textdh\ wenn sie keine \echte\ \Unteraussage\ enthält.
\end{description}
...
%%%			\rowcolor{cRareUse}
			...
			\tableline%.................................................
%%%			\rowcolor{cRareUse}
			\defSym{\OjkXor} $\dot\vee$ $\veebar$ $\oplus$
...
Ausgehend von den \Junktoren\ aus der \BooleschenSignatur\ $\OjkJun_\IdxBool$ werden die restlichen \Junktoren\ aus \OjkJun\ definiert.
...
Ist \chrqt{\OjkOr} oder \chrqt{\OjkAnd} nicht vorgegeben, \textdh\ wird von den Elementen aus $\OjkJun_\IdxAnd$ \textbzgl\ $\OjkJun_\IdxOr$ statt von denen aus $\OjkJun_\IdxBool$ ausgegangen, so muss man den fehlenden \Junktor\ mittels der passenden der beiden folgenden Definitionen einführen:
\begin{align}
	% and --> or -------------------
...
Bei Vorgabe von $\OjkJun_\IdxNand$ \textbzgl\ $\OjkJun_\IdxNor$ schließlich werden die passenden Definition aus
\begin{align}
	% nor --> not ------------------
...
Ausgehend von der \logischenSignatur\ $\OjkJun_\IdxAnd = \{\OjkNot, \OjkAnd\}$ und der \vrefdef{def-imp} von \chrqt{\OjkImp} werden die folgenden vier logischen \Axiome\ definiert:
\begin{align}
	&
