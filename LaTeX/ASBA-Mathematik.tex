...
%TODO Macht \hidden was es soll?
$\metaandsym$\hidden{\glsIdxPl{\metaand}} und $\metaorsym$\hidden{\glsIdxPl{\metaor}} heißen \defn{\Metaoperator} und \glsIdx{metaimp}, \glsIdx{metarep} und \glsIdx{metaequiv} \defn{\Metarelation}.
...
Zwei \Objekte\ $A$ und $B$ sind \defn{\glsIdx{vergleichbar}}, wenn beide von derselben Art sind, \textdh\ wenn \textzB\ jeweils beide Mengen, \Zeichenfolgen, Zahlen, \textusw\ sind.
