...
\begin{itemize}
	...
	%
	\item \emph{\glsIdxPl{Formel}} sind in diesem Dokument immer mathematische \glsIdxPl{Formel}.
	\glsIdxPl{Formel} werden stets als \glsIdxPl{Zeichenfolge}%
	\footnote{%
...
\begin{description}
	...
	\forqt{A = B} heißt, dass \objqt{A} und \objqt{B} sich in den \glsIdx{interessierende_Eigenschaft}{interessierenden Eigenschaften} für \objqt{=} nicht unterscheiden.%
	\footnote{%
	...
	\forqt{A \ne B} heißt, dass \objqt{A} und \objqt{B} sich in mindestens einer \glsIdx{interessierende_Eigenschaft} für \objqt{=} unterscheiden. \enquote{\objqt{A} ist \emph{nicht dasselbe} wie \objqt{B}} (aber vielleicht das gleiche; siehe \objqt{\equiv}) oder \enquote{\objqt{A} ist \emph{nicht identisch} zu \objqt{B}}.
	%
	\item[\objqt{\glsSym{equiv}}~~\emph{\Idx{Äquivalenz}}(relation)]\label{def:Äquivalenz}
	\forqt{A \equiv B} heißt, dass \objqt{A} und \objqt{B} sich in den \glsIdxBg{interessierende_Eigenschaft}{interessierenden Eigenschaften} für \objqt{\equiv} nicht unterscheiden.
	...
	\forqt{A \nequiv B} heißt, dass \objqt{A} und \objqt{B} sich in mindestens einer \glsIdx{interessierende_Eigenschaft} für \objqt{\nequiv} unterscheiden.
...
Jede \glsIdx{interessierende_Eigenschaft} für \objqt{\equiv} oder eine andere Äquivalenzrelation muss auch eine für \objqt{\eq} sein.
...
%
\begin{itemize}
	\item Mit den \glsIdxPl{Formel} aus \objqt{\Voraussetzungsmenge} (den \glsIdxPl{Voraussetzung}) lassen sich alle \glsIdxPl{Formel} aus \objqt{\Folgerungsmenge} (den \glsIdxPl{Folgerung}) durch \emph{\glsIdxPl{zulaessige_Transformation}} -- die noch definiert werden müssen -- ableiten.
\end{itemize}
%
\objqt{\Voraussetzungsmenge} und \objqt{\Folgerungsmenge} dürfen auch leer sein.
Eine \glsIdx{Schlussregel} wird von uns nicht als Formel angesehen, darf also kein Element von \objqt{\Voraussetzungsmenge} und \objqt{\Folgerungsmenge} sein.
Wir nennen eine \glsIdx{Schlussregel} auch einen \emph{\glsIdxBg{formaler_Satz}{formalen Satz}}.
Eine \glsIdxBg{allgemeingueltige_Schlussregel}{Schlussregel} \textbzw\ ein \glsIdx{formaler_Satz} heißt \emph{allgemeingültig}, wenn die zugehörige \glsIdx{Aussage} immer zutrifft.
In diesem Fall kann sie zur zulässigen Umwandlung von Formeln dienen.
Ferner gilt:
%
\begin{itemize}
	\item Die \glsIdx{Schlussregel} $\frac{\emptyset}{\Folgerungsmenge}$ nennen wir auch \emph{\glsIdx{Axiom}}, da sie als ein solches aufgefasst werden kann.
	\item Die \glsIdx{Schlussregel} $\frac{\Voraussetzungsmenge}{\emptyset}$ ist allgemeingültig.
\end{itemize}
...
Die \objqt{\Voraussetzung_n} \textbzw\ \objqt{\Folgerung_m} können dabei beliebig permutiert werden.
...
\begin{align}
	...
	\formulatoleft
\end{align}
wobei \objqt{K} ein Element von \objqt{\gsNo} ist und die \glsIdxPl{Beweisschritt} \objqt{\Beweisschritt_k} \glsIdxPl{Schlussregel}.
%
Wir definieren noch
\begin{align}
...
\end{align}
und nennen \objqt{\Beweisschrittmenge} die \emph{\glsIdx{Beweisschrittmenge}}.
Dann ist \objqt{\Beweisschrittmenge_{-1} = \emptyset} und \objqt{\Beweisschrittmenge_i \subseteq \Beweisschrittmenge_j \subseteq \Beweisschrittmenge} für \objqt{-1 \le i \le j \le K}.

========================================================================
%TODO===================================================================

Jeder \glsIdx{Beweisschritt} \objqt{\Beweisschritt_k \text{ für } 0 \le k \le K} muss entweder eine \glsIdx{Voraussetzung} aus \objqt{\Voraussetzungsmenge} oder durch Anwendung einer \glsIdxBg{allgemeingueltige_Schlussregel}{allgemeingültigen Schlussregel} auf eine Teilmenge von \objqt{\Beweisschrittmenge_{k-1}} eine wahre Formel oder eine weitere \glsIdx{allgemeingueltige_Schlussregel} sein.
...
\begin{table}
	...
	\begin{threeparttable}
		...
		\begin{tabularx}{\linewidth}{|c||c:cc:cccc|X:X|c|}
			...
			\objqt{\Sym{(\dots)}}
			& - & \texttrue  & \textfalse & - & - & - & -
			& Klammerung          & A ist geklammert & -\Tnote{4}        \\
			\tableline%.................................................
			\rowcolor{cNormalUse}
			\objqt{\Sym{\lnot}}
			& - & \textfalse & \texttrue  & - & - & - & -
			& Negation            & Nicht A          & \thepnot\Tnote{5} \\
			\tableline%.................................................
			& - & \textfalse & \textfalse & - & - & - & - & & & -  \\
...
Sie können dabei auch als \emph{\glsIdx{atomare_Formel}} bezeichnet werden, \textdh\ \glsIdxPl{Formel}, die sich nicht weiter zerlegen lassen.\footnote{%
...
\begin{align}
	...
	\formulatoleft\formulatoleft\formulatoleft
\end{align}
Solche Teilmengen heißen \glsIdx{logische_Signatur}.
%
...
Ausgehend von den Operatoren aus der \glsIdxBg{Boolsche_Signatur}{Boolschen Signatur} $\alJun_\xBool$ werden die restlichen Operatoren aus $\alJun$ definiert. Die Definitionen sind in zwei Gruppen eingeteilt, und zwar die mit den Operatoren aus $\alJun_\xAnd$:
\begin{align}
	% folgt ------------------------
...
Ausgehend von der \glsIdxBg{logische_Signatur}{logischen Signatur} $\alJun_\xAnd = \{\lnot, \land\}$ und der \vrefdef{def:imp} von \symqt{\limp} werden die folgenden vier logischen \glsIdxPl{Axiom} definiert:
\begin{align}
	&
