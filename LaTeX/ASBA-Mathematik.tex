...
Dazu seien $\alpha$, $\beta$ und $\gamma$ \glsIdxPl{vergleichbar}\footnote{%
	\seename\ Ende von \subsectionname~\vref{sub:Metaausdruck}%
} \glsIdxPl{formalesElementV}. Zunächst wird definiert:
\begin{align}
...
\begin{itemize}
	...
	\footnote{%
		\seename\ Definition~\eqref{def:Substitutionen} von \subsectionname~\vref{sub:Indentitaetsregeln}%
	}.
