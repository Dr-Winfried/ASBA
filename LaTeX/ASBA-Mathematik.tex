...
\begin{table}[!htb]
	...
	\begin{tabular}{|c||c|c|c|c|c|c|}
		...
		\\\hline\hline
		1 & Annahme & & & & $ X \abltb \alpha $ & $A_1$
		\\\hline
		2 & Annahme & & & & $ X,\alpha \abltb \beta $ & $A_2$
		\\\hline
		3 & Annahme     & & & & $ X \abltb \beta $ & $A_3$
		\\\hline
		4 & \MR & $ Y \subst X,\lnot\alpha $ & $ \dfrac{X\abltb\alpha}{X, \lnot\alpha \abltb \alpha} $ & $A_1$ & $ X, \lnot\alpha \abltb \alpha $ & $A_1, \MR $
		\\\hline
		5 & \AR & $ \alpha \subst \lnot\alpha $ & $ \dfrac{}{\lnot\alpha \abltb \lnot\alpha} $ & & $ \lnot\alpha \abltb \lnot\alpha $ & \AR
		\\\hline
		6 & \MR & $ \alpha \subst \lnot\alpha $ & $ \dfrac{X \abltb \lnot\alpha}{Y \abltb \lnot\alpha} (Y \supseteq X) $ & & &  \MR
		\\\hline
		7 & $\overline{R}_6$ & $ X \subst \lnot\alpha $ & $ \dfrac{\lnot\alpha \abltb \lnot\alpha}{Y \abltb \lnot\alpha} (Y \supseteq \{\lnot\alpha\}) $ & & & \MR
		\\\hline
		8 & $\overline{R}_7$ & $ Y \subst X,\lnot\alpha $ & $ \dfrac{\lnot\alpha \abltb \lnot\alpha}{ X,\lnot\alpha \abltb \lnot\alpha} $ & $A_5$ & $ X,\lnot\alpha \abltb \lnot\alpha $ & \AR, \MR
		\\\hline
		...
		\\\hline\hline
		11 & & & $\dfrac{A_1 \und A_2}{A_3} $ & & $ \dfrac{X\abltb\alpha \und X,\alpha\abltb\beta}{X\abltb\beta} $ &
...
\begin{enumerate}
	...
	\begin{enumerate}
		...
		\item $(R_n) =$ \strqt{Annahme}%
		\footnote{Zur Unterscheidung von Voraussetzung und Folgerung kann bei einer Voraussetzung hier auch  \strqt{feste Annahme} stehen.}.
	...
	\begin{enumerate}
		...
		\item $(n) =$ Die aktuelle Zeilennummer $i$.
		%
		\item $(\overline{R}_n) =$ Die bewiesene Behauptung (mathematischer Satz) in der Form eines \emph{\glsIdxBg{formalerSatzV}{formalen Satzes}}\footnote{\seename~\eqref{def:formalerSatz} \sectionname~\vref{sec:Schlussregeln}} mit Voraussetzungen und Folgerungen.
		%
...
\begin{table}[!htb]
	...
	\begin{tabular}{|c||c|c|c|c|c|c|}
		...
		\parbox{1.95cm}{\centering\textbf{Abhängig-} \newline\textbf{keiten}  ($D_n$)}
		\\\hline \hline
		1 & Annahme & & & & $(\alpha \limp \beta)$ & $A_1$
		\\\hline
		2 & Annahme & & & & $ \lnot\beta $         & $A_2$
		\\\hline
		3 & Annahme & & & & $ \alpha $             & $A_3$
		\\\hline
		4 & $R_n$ & $S_n$ & $\overline{R}_n$ & $A_1$, $A_3$ & $\beta$ & $A_1$, $A_3$
		\\\hline
		4 & $\impB$ & $S_n$ & $ \dfrac{X\abltb\alpha\limp\beta}{X,\alpha\abltb\beta} $ & $A_1$, $A_3$ & $\beta$ & $A_1$, $A_3$
		\\\hline
		...
		\\\hline
	\end{tabular}
	\caption{Ableitung der \glsIdx{Kontraposition} aus ???}
