...
Eine \glsIdx{Schlussregel} steht für die \Aussage, dass mit ihren \glsIdxPl{Voraussetzung} auch auch ihre \glsIdxPl{Folgerung} gelten.
...
\begin{enumerate}
	...
	\begin{enumerate}
		...
		-- Wenn diese \glsIdxPl{Folgerung} schon als \Aussagen\ $A_j$ (mit $j < i$) vorhanden sind, können auch einfach deren Indizes eingetragen werden.
		...
		%
	\end{enumerate}
	Der \Beweis\ muss so lange fortgeführt werden, bis alle \glsIdxPl{Folgerung} als \Aussagen\ in der Spalte $(A_n)$ erschienen und dort jeweils nur von den gegebenen \glsIdxPl{Voraussetzung} abhängig sind.
	%
