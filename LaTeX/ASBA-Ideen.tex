...
\begin{table}[!htb]
	...
	\begin{tabular}{|c||c|c|c|c|c|c|}
		...
		\\\hline
		6 & -1 & $X \MtsSubst \emptyset$ & $\dfrac{\alpha\OjkImp\beta}{\alpha \MtsDerive \beta}$ & 2 & $\alpha \MtsDerive \beta $ & 2
		\\\hline
		...
		\\\hline
		10' & -1 & $X \MtsSubst \emptyset$ & $\dfrac{\alpha \MtsUnd \beta}{\alpha \OjkAnd \beta}$ & & &
		\\\hline
		11' & -1 &\SnCell{
			$\alpha \MtsSwap \beta$\\
		...
		9 & \ref{def-nota} & & $\dfrac{X \MtsDerive \alpha, \OjkNot\alpha}{X \MtsDerive \beta}$ & & &
		\\\hline
		10 & -1 & $X \MtsSubst \emptyset$ & $\dfrac{\alpha \MtsUnd \OjkNot\alpha}{\beta}$ & & &
		\\\hline
		11 & -1 & \SnCell{
			$\alpha \MtsSwap \beta$\\
			$\alpha \MtsSubst \OjkNot\alpha$
		...
		\\\hline
		13 & -1 & $X \MtsSubst \emptyset$ & $\dfrac{\alpha \MtsDerive \beta}{\alpha\OjkImp\beta}$ & & &
		\\\hline
		14 & -1 & \SnCell{
			$\alpha \MtsSwap \beta$\\
			$\alpha \MtsSubst \OjkNot\alpha$\\
