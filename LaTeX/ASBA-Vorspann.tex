...
\newglossaryentry{subst}{
	...
	description={%
		...
		(siehe die Definition in \subsectionname~\vref{sub:Indentitaetsregeln})%
	}
}
...
\newglossaryentry{Substitution}{
	...
	description={%
		...
		(siehe die Definition~\eqref{def:Substitution} in \subsectionname~\vref{sub:Indentitaetsregeln})%
	}
}
...
\newglossaryentry{Vertauschung}{
	...
	description={%
		...
		(siehe die Definition~\eqref{def:Vertauschung} in \subsectionname~\vref{sub:Indentitaetsregeln})%
	}
}
