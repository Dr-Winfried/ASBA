...
% Spezielle Quotierung von
% Objekten                          [ob], Zeichen [char] und Zeichenketten [str]
% Relationen, Operatoren, Operanden [op], Symbolen [sym] und Formeln       [for]
% Erstere werden im Text-, letztere im Mathematikmodus ausgegeben.
\newcommand*{\objqt} [1]              {#1}%                Objekte
\newcommand*{\charqt}[1]{\guilsinglleft#1\guilsinglright}% Zeichen
\newcommand*{\strqt} [1]{\guillemotleft#1\guillemotright}% Zeichenketten
% Parameter wird mit $...$ umgeben
\newcommand*{\opqt} [1]{\objqt {$#1$}}%        Relationen, Operatoren, Operanden
\newcommand*{\symqt}[1]{\charqt{$#1$}}%                    Symbole
\newcommand*{\forqt}[1]{\strqt {$#1$}}%                    Formeln
