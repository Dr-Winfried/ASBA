...
\newcommand*{\GlsIdxPl}[2][]{\Glspl{#2}\idx[#1]{#2}}% 2+=idx; plural
\newcommand*{\glsIdy}  [3][]{\gls  {#2}\idx[#1]{#2}}%
\newcommand*{\glsIdyPl}[3][]{\glspl{#2}\idx[#1]{#3}}%         plural
%TODO \glsIdZBg muss noch aufgelöst werden
\newcommand*{\glsIdZBg}[3][]        {#3\idx[#1]{\gls{#2}}}%
% Symbole;...;#3=sym=Symbol-Eintrag;...
\newcommand*{\sym}     [2][]{\sindex[sym]{\ensuremath{#2}|#1}}% 2=sym
%TODO \glsSxm muss noch aufgelöst werden
\newcommand*{\glsSxm}  [2][]{\gls{#2}\sym{\gls{#2}}}% 2+=sym
\newcommand*{\glsSym}  [3][]{\gls{#2}\sym[#1]{\ensuremath{#3}}}%

% Hervorhebung von neu definierten Begriffen
\newcommand*{\defn}      [1]{\textbf{#1}}
\newcommand*{\textdef}   [1]{\textbf{\hyperpage{#1}}}% ein Font-Kommando
% Die folgenden #1 müssen am Ende ein Makro mit genau einem optionalen
% Parameter sein, der ein Font-Kommando verarbeiten kann.
% Die Makros für #1 werden in Vorspann-Glossar definiert.
\newcommand*{\definition}  [1]  {\defn{#1[textdef]}}
\newcommand*{\opdefinition}[1]{\;\defn{#1[textdef]}\;}% umgebender Abstand
\newcommand*{\undefinition}[1]  {\defn{#1[textdef]}\;}% folgender  Abstand
