...
\newcommand*{\linkcolor}[1]{\textcolor{blue}{#1}}% Farbe der internen Links
\newcommand*{\wikilink} [1]{\textcolor{blue}{#1}}% Farbe der Links in Wikipedia
\newcommand*{\wikibf}   [1]{\textbf         {#1}}% Bold font in Wikipedia
\newcommand*{\wikiit}   [1]{\textit         {#1}}% Italic font in Wikipedia
...
\newcommand*{\Datei}[5][0.5]{% #2 x #3 = (-#2/2,-#3/2),(#2/2,#3/2)
	...
	\put(0,0){\oval[#1](#2,#3)}
	\put(0,+0.25){\makebox(0,0){\textbild{#4}}}
	\put(0,-0.25){\makebox(0,0){\textbild{#5}}}
}
...
\newcommand*{\Papier}[4]{% 3x#1+#2 = (0.0,-#2),(2.1,#1) Ursprung links unten
	...
	\put(0,+0.25){\makebox(+2.8,+#1){\textbild{#3}}}
	\put(0,-0.25){\makebox(+2.8,+#1){\textbild{#4}}}
}
...
% Text-Fonts in 'ASBA-Vorspann-Glossar.txt'
