...
\newcommand*{\tageqB}{$\eq$B}% Argument für \tag
\newglossaryentry{eqB}{
	name={($ \eq     $B)},
	plural={(\eq\text{B})},% im Mathematikmodus
	description={%
		Beseitigung von \symqt{$\eq$}%
	}
}
\newcommand*{\tageqE}{$\eq$E}% Argument für \tag
\newglossaryentry{eqE}{
	name={($ \eq     $E)},
	plural={(\eq\text{E})},% im Mathematikmodus
	description={%
...
\newglossaryentry{gueltigeSchlussregel}{
	name={gültige Schlussregel},
	plural={gültige Schlussregeln},
	description={%
		Eine \glsIdx{Schlussregel} die aus den \glsIdxPl{Basisregel} und den schon als gültig abgeleiteten \glsIdxPl{Schlussregel} abgeleitet werden kann%
	}
}
\newglossaryentry{Identitaetsregel}{
	...
	description={%
		...
		Da sie nur zur Rechtfertigung der Substitution verwendet werden, werden sie hier aber nicht dazu gezählt.%
	}
}
...
\newglossaryentry{zulaessigeTransformationA}{
	...
	description={%
		...
		\textdh die Anwendung einer \glsIdxBg{gueltigeSchlussregel}{gültigen Schlussregel}%
	}
}
