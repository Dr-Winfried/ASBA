...
%%% ggf. noch \autoref u.a. von 'hyperref' nutzen; dazu:
...
\newcommand*{\synonym}     [2][]{\footnote{synonym:      \defFt{#2}#1}}
\newcommand*{\alternativ}  [2][]{\footnote{alternativ:   \defFt{#2}#1}}
...
\newenvironment{citeWiki}[3][\Wikipedia]{%
	#1 \cite{#2} schreibt dazu (Zitat#3):
	\begin{quote}
		\sffamily
}{%
	\end{quote}
