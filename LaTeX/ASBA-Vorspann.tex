...
% Schalter zum Testen
\newif\ifWPTtest% Schalter zum Testen; noch AUS
\WPTtesttrue%      allgemeiner Test         EIN

\newcommand*{\WPTerrorIfDefined}[1]{% Testen, ob '\#1' schon definiert ist. Wenn ja, Fehlerausgabe
	\ifWPTtest
		\ifx#1\WPTundefined
		\else
			\errmessage{WPT: Schon definiert \string#1 : \meaning#1}
		\fi
	\else
	\fi
}
...
\usepackage{amssymb}%        Zusätzliche Mathesymbole (z.B. IR)
...
%\usepackage{url}%     URLs einfügen: \url{http://...}; ersetzt durch 'hyperref'
% weiter empfohlen -------------------------------------------------------------
...
\ifWPTtest % Start: Nur für Entwicklung und Test ===============================
...
%\setlength{\marginparwidth}{2cm}% Breite des Seitenrandes für 'showidx'
\else \fi %  Ende:  Nur für Entwicklung und Test -------------------------------
...
\usepackage[nopostdot,section=section,toc,xindy={glsnumbers=false}]{glossaries}
%%%\usepackage[...,index,nohypertypes={index},...]{glossaries}
% Paket 'glossaries': 
% - nach 'hyperref'
...
\newcommand*{\alternativ}    [1]{\footnote{alternativ:    \defFt{#1}}}
\newcommand*{\alternativen}  [2]{\footnote{alternativ:    \defFt{#1} oder \defFt{#2}}}
