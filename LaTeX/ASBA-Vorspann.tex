...
\newcommand*{\strqt}[1]{\enquote{\textbf{\texttt{#1}}}}% Zeichenkette/Textmode
% Parameter wird in den Mathematikmodus versetzt, d.h. mit $...$ umgeben.
\newcommand*{\objqt}[1]              {$#1$}%                Objekt
\newcommand*{\symqt}[1]{\guilsinglleft$#1$\guilsinglright}% Symbol
\newcommand*{\forqt}[1]{\guillemotleft$#1$\guillemotright}% Formel
