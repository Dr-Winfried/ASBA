...
\begin{flushleft}
	\begin{thebibliography}{12}
		...
		\footnote{%
			...
			Das Datum hinter dem Link gibt -- je nachdem was erfahrbar ist -- das Datum der letzten Änderung, den Stand der Seite oder das Datum, an dem die Seite angeschaut wurde an.
