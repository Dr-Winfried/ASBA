...
\begin{flushleft}
	\begin{thebibliography}{12}
		...
		\bibitem{bib:Oberschelp} Jürgen Michael Glubrecht / Arnold Oberschelp / Günter Todt,
		\emph{Klassenlogik}
		...
		\tourl{http://www.ruhr-uni-bochum.de/www-rz/schwanbs/TeX/}
		--- 06.02.2002
		\footnote{%
		...
		\bibitem{bib:GPLi} \emph{GNU General Public License}, Version 1
		...
		\bibitem{bib:GPLiii} \emph{GNU General Public License}, Version 3
		\tourl{http://www.gnu.org/licenses/gpl}
		--- 29.06.2007

		\bibitem{bib:LGPLii} \emph{GNU Lesser General Public License}, Version 2.1
		\tourl{http://www.gnu.org/licenses/old-licenses/lgpl-2.1}
		--- 02.1999

		\bibitem{bib:LGPLiii} \emph{GNU Lesser General Public License}, Version 3.0
		\tourl{http://www.gnu.org/licenses/lgpl}
		--- 29.06.2007
		...
		\tourl{https://de.wikipedia.org/wiki/Ableitung\_(Logik)}
		--- 20.02.2018

		\bibitem                        {bib:Aussage} Wikipedia:
		\emph                               {Aussage  (Logik)}
		\tourl{https://de.wikipedia.org/wiki/Aussage\_(Logik)}
		--- 11.03.2018
		...
		\emph                               {Aussagenlogik}
		\chaptername~4 \emph                               {Formaler  Zugang}
		\tourl{https://de.wikipedia.org/wiki/Aussagenlogik\#Formaler\_Zugang}
		--- 18.01.2018

		\bibitem                        {bib:Begriff} Wikipedia:
		\emph                               {Begriff}
		\tourl{https://de.wikipedia.org/wiki/Begriff}
		--- 12.03.2018

		\bibitem                        {bib:Benennung} Wikipedia:
		\emph                               {Benennung}
		\tourl{https://de.wikipedia.org/wiki/Benennung}
		--- 12.05.2015

		\bibitem                        {bib:Beweis} Wikipedia:
		\emph                               {Beweis  (Mathematik)}
		\tourl{https://de.wikipedia.org/wiki/Beweis\_(Mathematik)}
		--- 08.11.2017

		\bibitem                        {bib:Bezeichnung} Wikipedia:
		\emph                               {Bezeichnung}
		\tourl{https://de.wikipedia.org/wiki/Bezeichnung}
		--- 25.02.2018

	\bibitem                        {bib:Darstellung} Wikipedia:
	\emph                               {Darstellung  (Wiedergabe)}
	\tourl{https://de.wikipedia.org/wiki/Darstellung\_(Wiedergabe)}
	--- 31.10.2016

		\bibitem                        {bib:Diskursuniversum} Wikipedia:
		\emph                               {Diskursuniversum}
		\tourl{https://de.wikipedia.org/wiki/Diskursuniversum}
		--- 12.01.2017

		\bibitem                        {bib:Element} Wikipedia:
		\emph                               {Element  (Mathematik)}
		\tourl{https://de.wikipedia.org/wiki/Element\_(Mathematik)}
		--- 09.01.2016

		\bibitem                        {bib:Folge} Wikipedia:
		\emph                               {Folge  (Mathematik)}
		\tourl{https://de.wikipedia.org/wiki/Folge\_(Mathematik)}
		--- 14.02.2018

		\bibitem                        {bib:Fachgebiet} Wikipedia:
		\emph                               {Fachgebiet}
		\tourl{https://de.wikipedia.org/wiki/Fachgebiet}
		--- 17.01.2018

		\bibitem                        {bib:Funktion} Wikipedia:
		\emph                               {Funktion  (Mathematik)}
		\tourl{https://de.wikipedia.org/wiki/Funktion\_(Mathematik)}
		--- 12.03.2018

		\bibitem                        {bib:FunktionMengentheoretisch} Wikipedia:
		\emph                               {Funktion  (Mathematik)}
		\chaptername~2.1 \emph                                      {Mengentheoretische  Definition}
		...
		\emph                               {Hilbert-Kalkül} \chaptername~1.4
		\emph                                                      {Modus  (ponendo)  ponens}
		\tourl{https://de.wikipedia.org/wiki/Hilbert-Kalk\%C3\%BCl\#Modus\_(ponendo)\_ponens}
		\ifmarginparFlg\newline\else\fi
		--- 18.06.16

		\bibitem                        {bib:Identitaet} Wikipedia:
		\emph                               {Identität         (Logik)}
		\chaptername~2.3 \emph                                         {Identität       in  der  Informatik}
		\tourl{https://de.wikipedia.org/wiki/Identit\%C3\%A4t\_(Logik)\#Identit.C3.A4t\_in\_der\_Informatik}
		--- 18.05.2017

		\bibitem                        {bib:Intuitionismus} Wikipedia:
		\emph                               {Intuitionismus  (Logik  und  Mathematik)}
		\tourl{https://de.wikipedia.org/wiki/Intuitionismus\_(Logik\_und\_Mathematik)}
		--- 22.06.2018

		\bibitem                        {bib:Junktor} Wikipedia:
		\emph                               {Junktor}
		\tourl{https://de.wikipedia.org/wiki/Junktor}
		--- 18.03.2017

		\bibitem                        {bib:JunktorMoeglich} Wikipedia:
		\emph                               {Junktor} \chaptername~2.2
		\emph                                        {Mögliche       Junktoren}
		...
		\bibitem                        {bib:kartesischesProdukt} Wikipedia:
		\emph                               {Kartesisches  Produkt}
		\tourl{https://de.wikipedia.org/wiki/Kartesisches\_Produkt}
		--- 21.02.2018

		\bibitem                        {bib:Klasse} Wikipedia:
		\emph                               {Klasse  (Mengenlehre)}
		\tourl{https://de.wikipedia.org/wiki/Klasse\_(Mengenlehre)}
		--- 25.03.2018

		\bibitem                        {bib:Klassenlogik} Wikipedia:
		\emph                               {Klassenlogik}
		\tourl{https://de.wikipedia.org/wiki/Klassenlogik}
		--- 05.01.2017

		\bibitem                        {bib:Konstante} Wikipedia:
		\emph                               {Konstante  (Logik)}
		\tourl{https://de.wikipedia.org/wiki/Konstante\_(Logik)}
		--- 20.01.2016
		...
		\bibitem                        {bib:mathematischeLogik} Wikipedia:
		\emph                               {Mathematische  Logik}
		\tourl{https://de.wikipedia.org/wiki/Mathematische\_Logik}
		--- 21.03.2018

		\bibitem                        {bib:mathematischesObjekt} Wikipedia:
		\emph                               {Mathematisches  Objekt}
		\tourl{https://de.wikipedia.org/wiki/Mathematisches\_Objekt}
		--- 29.06.2018

		\bibitem                        {bib:Menge} Wikipedia:
		\emph                               {Menge}
		\tourl{https://de.wikipedia.org/wiki/Menge\_(Mathematik)}
		--- 07.03.2018
...
\bibitem                        {bib:Quantor} Wikipedia:
\emph                               {Quantor}
\tourl{https://de.wikipedia.org/wiki/Quantor}
--- 12.03.2018

		\bibitem                        {bib:Relation} Wikipedia:
		\emph                               {Relation  (Mathematik)}
		\tourl{https://de.wikipedia.org/wiki/Relation\_(Mathematik)}
		--- 16.03.2018

		\bibitem                        {bib:RelationMehrstellig} Wikipedia:
		\emph                               {Relation  (Mathematik)}
		\chaptername~1.1 \emph                                      {Mehrstellige  Relation}
		\tourl{https://de.wikipedia.org/wiki/Relation\_(Mathematik)\#Mehrstellige\_Relation}
		--- 27.01.2018

		\bibitem                        {bib:TertiumNonDatur} Wikipedia:
		\emph                               {Satz  vom  ausgeschlossenen  Dritten}
		\tourl{https://de.wikipedia.org/wiki/Satz\_vom\_ausgeschlossenen\_Dritten}
		--- 13.01.2018
		...
		\tourl{https://de.wikipedia.org/wiki/Signatur\_(Modelltheorie)}
		--- 04.03.2018
		...
		\bibitem                        {bib:Semantik} Wikipedia:
		\emph                               {Semantik}
		\tourl{https://de.wikipedia.org/wiki/Semantik}
		--- 04.03.2018

		\bibitem                        {bib:Syntax} Wikipedia:
		\emph                               {Syntax}
		\tourl{https://de.wikipedia.org/wiki/Syntax}
		--- 14.11.2017

		\bibitem                        {bib:Terminus} Wikipedia:
		\emph                               {Terminus}
		\tourl{https://de.wikipedia.org/wiki/Terminus}
		--- 13.01.2018
		...
		\tourl{https://de.wikipedia.org/wiki/Variable\_(Mathematik)}
		--- 08.03.2018
