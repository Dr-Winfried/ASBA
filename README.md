...
- Die Eingabe von Daten erfolgt in einer formalen Syntax. Folgende Daten können eingegeben werden:
  ...
  Dabei sind alle Daten nur innerhalb eines (übergeordneten) Fachgebietes gültig. Das oberste Fachgebiet ist die ganze Mathematik.
...
- Zusätzlich zur Ausgabe der Daten sind verschiedene Auswertungen möglich. Insbesondere kann zu jedem Beweis eines Satzes angegeben werden, wie viele Beweisschritte und welche Axiome und Sätze er benötigt.
